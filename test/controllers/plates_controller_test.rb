...
class PlatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plate" do
    assert_difference("Plate.count") do
      post plates_url, params: { plate: { amount: @plate.amount, description: @plate.description, name: @plate.name } }
    end
  ...
  test "should update plate" do
    patch plate_url(@plate), params: { plate: { amount: @plate.amount, description: @plate.description, name: @plate.name } }
